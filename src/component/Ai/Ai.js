            ...
            <div className='avatars_head'>
                <div className='section_head_padding_2'>
                    <div className='section_head_padding'>
                        ...
                        <p className='heygen_para is-light avatar'>Choose your perfect avatar covering different ethnicities, ages, poses and clothes.</p>
                    </div>
                    <div className='_2_btns_or_wrap'>
                        <a href="https://app.heygen.com/login" className='button_primary w-inline-block'>
